...
<!-- form -->
<div class="content inside-page lookbook">
       ...
       <div class="row">
       	<div class="col-sm-8 col-sm-offset-2">
       		...
       		<div class="product">       		
       		<img src="images/products/88.jpg" class="img-responsive"  alt="product">
       		<div class="info">
       			<h3>Primavera</h3>
       			<p>Tu vestuario adecuado para cualquier estacion del año.</p>
       			<a href="#" class="btn btn-primary">Ver Colección</a>
       		</div>
       		</div>
       		...
       		<div class="product">       		
       		<img src="images/products/99.jpg" class="img-responsive" alt="product">
       		<div class="info">
       			<h3>Verano</h3>
       			<p>Tu vestuario adecuado para cualquier estacion del año.</p>
       			<a href="#" class="btn btn-primary">Ver Colección</a>
       		...
       		<div class="product">       		
       		<img src="images/products/100.jpg" class="img-responsive" alt="product">
       		<div class="info">
       			<h3>Casual</h3>
       		...
       		<div class="product">       		
       		<img src="images/products/111.jpg" class="img-responsive" alt="product">
       		<div class="info">
       			<h3>A la Moda</h3>
       			<p>Tu vestuario adecuado para cualquier estacion del año.</p>
       			<a href="#" class="btn btn-primary">Ver Colección</a>
       		...
       		<div class="product">       		
       		<img src="images/products/10.jpg" class="img-responsive" alt="product">
       		<div class="info">
       			<h3>Sensual</h3>
       			<p>Tu vestuario adecuado para cualquier estacion del año.</p>
       			<a href="#" class="btn btn-primary">Ver Colección</a>
