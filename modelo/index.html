...
<!-- banner & block -->
    	...
    	<div id="BannerCarousel" class="carousel slide  height-full" data-ride="carousel">
    	 <div class="carousel-inner  height-full">
        	<div class="item active  height-full">
                ...
                <div class="caption"><h2 class="animated fadeInDown">Marca líder de Londres y París</h2>
                <p class="animated fadeInUp">Tu vestuario adecuado para cualquier estacion del año</p>
                <a href="collections.php" class="btn btn-default animated fadeInLeftBig">Ver Productos</a> <a href="lookbook.php" class="btn btn-default animated fadeInRightBig">Coleccion</a>
                </div>
            </div>
        	<div class="item  height-full">
                <img src="images/slide22.jpg"  class="img-responsive" alt="slide">
                <div class="caption"><h2  class="animated fadeInDown">Marca líder de Londres y París</h2>
                <p class="animated fadeInUp">Tu vestuario adecuado para cualquier estacion del año</p>
                <a href="collections.php" class="btn btn-default animated fadeInLeftBig">Ver Productos</a> <a href="lookbook.php" class="btn btn-default animated fadeInRightBig">Coleccion</a>
                </div>
            ...
            <div class="item  height-full">
                <img src="images/slide55.jpg"  class="img-responsive" alt="slide">
                <div class="caption"><h2  class="animated fadeInDown">Marca líder de Londres y París</h2>
                <p class="animated fadeInUp">Tu vestuario adecuado para cualquier estacion del año</p>
                <a href="collections.php" class="btn btn-default animated fadeInLeftBig">Ver Productos</a> <a href="lookbook.php" class="btn btn-default animated fadeInRightBig">Coleccion</a>
                </div>
    ...
    <div class="col-md-6 col-sm-4 height-full">
        <div class="height-full">
            <div class="col-md-6 col-xs-12 height-half animated fadeInUp"><div class="block height-full women "><a href="collections.php" class="info animated fadeInDown"><h3>Mujer</h3><span>21459 Productos</span></a></div></div>
            <div class="col-md-6 col-xs-12 height-half animated fadeInDown"><div class="block height-full store"><div class="overlay"><div class="store-info"><div class="desc"><h4>Mas de 2500 productos</h4><p>Tu vestuario adecuado para cualquier estacion del año.</p><a href="contact.php"  class="btn btn-default">Nuestra TIenda</a></div></div></div></div></div>
            <div class="col-md-6 col-xs-12 height-half animated fadeInDown"><div class="block height-full men"><a href="coleccion2.php" class="info animated fadeInDown"><h3>Hombre</h3><span>1874 Productos</span></a></div></div>
            <div class="col-md-6 col-xs-12 height-half animated fadeInUp"><div class="block height-full couple"><a href="coleccion3.php" class="info animated fadeInDown"><h3>Regalos</h3><span>398 Productos</span></a></div></div>            
        </div>
    </div>
