...
<div class="container">
	...
	<div class="breadcrumb"><a href="index.php">Inicio</a> / <a href="collections.php">Colección</a> / Vestido Corto</div>	
	<div class="row">
		<div class="col-sm-5">
		...
		<!--	<div class="clearfix">
			...
			<div class="description-tabs">
				...
				<li><a href="#review" role="tab" data-toggle="tab">Comentario (2)</a></li>
				</ul>

				<!-- Tab panes -->
				<div class="tab-content">
				<div class="tab-pane active" id="description">
				Vestido corto adecuado para un dia de verano. Puedes enseñar tus atractivas piernas y lucir hermosa y radiante.
				</div>
				<div class="tab-pane" id="review">
				
					<div class="reviews">
					<h5>Maria Yepez</h5>
					<p>Bello este vestido</p>
					</div>

					<div class="reviews">
					<h5>Maria Aponte</h5>
					<p>Genial para pasar un dia con comodidad</p>
					</div>

				<textarea class="form-control" rows="3" >Escribe tu comentario aqui</textarea>
				<a href="#" class="btn btn-primary">Siguiente comentario</a>
				</div>
				</div>
			</div>
			...
			<div class="clearfix">
				<a href="#" class="btn btn-primary"><i class="fa fa-heart"></i> Lista</a>
				<a href="#" class="btn btn-primary"><i class="fa fa-exchange"></i> Comparte</a>
				<a href="#" class="btn btn-primary"><i class="fa fa-envelope"></i> Enviar Email</a>				
			</div>
		</div>
	</div>
